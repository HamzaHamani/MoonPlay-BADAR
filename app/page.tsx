          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                The all-in-one IPTV platform offering access to premium live TV,
                sports, movies, and series — anytime, anywhere. Cut the cords
          ...
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                ...
                crystal-clear quality, global channels, and 24/7 support. Here's
                why users love it:
              </p>
            </motion.div>
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Stream smarter with MoonPlay — over 3000 channels, one powerful
                IPTV platform, endless entertainment.
              </p>
